...
void main() {
  debugPrint('Running Statistics Service Unit Tests...');
  ...
  try {
    ...
    if (((stats['attendance_percentage'] as double) - expectedPercentage)
                .abs() <
            0.01 &&
  ...
  if (passedTests == totalTests) {
    debugPrint('🎉 All tests passed! The statistics service is working correctly.');
  } else {
    debugPrint(
